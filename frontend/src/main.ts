...
window.onload = async () => {
    ...
    const ramp = new Ramp(material, new Vec3(0, -2, 0), new Vec3(0, 0, 0), new Vec3(10, 5, 10));
    const wall = new Cube(material, new Vec3(0, 0, 6.9), new Vec3(0, 0, 0), new Vec3(10, 10, 5));

    const light = new LightCube(material);
